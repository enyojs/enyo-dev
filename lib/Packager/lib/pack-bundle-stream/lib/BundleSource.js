...
function BundleSource (bundle, opts, bundler) {
	...
	this.entries = [];
	this.manifest = new BundleManifest(bundle, opts, this.map, this.line);
	this.contents = '';
	this.sourceMap = '';
	this.sourceMapFile = '';
...
proto.getModuleFromName = function (name) {
	return this.bundler.getModuleFromName(name);
};

proto.getBundleFromName = function (name) {
	return this.bundler.getBundleFromName(name);
};

proto.getBundleForModule = function (entry) {
	return this.bundler.getBundleForModule(entry);
};

proto.pack = function () {
	var packer, bundle, manifest;
	packer = this;
	bundle = this.bundle;
	...
	bundle.order.forEach(function (name) {
		var entry;
		entry = packer.getModuleFromName(name);
