...
(function () {
	...
	var   request = enyo.request || (defineProperty(enyo, 'request', {value: enyoRequest}) && enyo.request)
		, pending = enyo.__pendingRequests__ || (defineProperty(enyo, '__pendingRequests__', {value: {}}))
	...
	if (!Request) {
		...
		"then" handler is past to it. Here, we facade the normal behavior by passing a nop to
