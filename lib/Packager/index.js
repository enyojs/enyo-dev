...
Packager.prototype.setupBundle = function (bundle) {
	...
	// globals is true by default in development and false by default in production.
	if ((this.devMode && this.globals === false) || (!this.devMode && this.globals !== true)) {
		bundle.ignore(path.join(this.libPath, 'enyo/lib/global.js'));
	}
