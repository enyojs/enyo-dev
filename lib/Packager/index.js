...
Packager.prototype.processIncludedLibraries = function () {
	...
	logger.log('debug', 'processing included libraries for additional package dependencies', this.includeLibs);
...
Packager.prototype.processPackages = function () {
	...
	this.packages.order.reverse();
	
	logger.log('debug', 'processing final packages', this.packages.order);
