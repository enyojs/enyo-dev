...
function EnyoEnv (opts) {
	...
	this.configFile = path.resolve(opts.configFile || '.enyoconfig');
...
proto.initPackage = function () {
	var
		enyo = this,
		file = this.packageFile = path.join(process.cwd(), 'package.json');
